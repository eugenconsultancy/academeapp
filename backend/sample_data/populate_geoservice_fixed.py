...
Fixed version with proper User model fields.
Run with: python sample_data/populate_geoservice_fixed.py
"""
...
def create_sample_users():
    """Create sample test users with required phone numbers"""
